...
<html lang="en">
  ...
  <body style="background-color:#13795B">
    <div class="col-xl-5 bg-light border position-absolute start-50 translate-middle" style="top: 35%">
        <h4 class="text-center">Peduliaalam <i class="fa-solid fa-leaf"></i></h4>
